...
def predict_price(year,town,flat_type,flr_area_sqm,flat_model,stry_start,stry_end,rem_les_year,
              rem_les_month,les_coms_dt):
    ...
    rem_les_year= int(rem_les_year)
    rem_les_month= int(rem_les_month)
    lese_coms_dt= int(les_coms_dt)


    with open(r"C:\Users\Viswa.DP-PC\New folder\project\singapore\Resale_Flat_Prices_Model_1.pkl","rb") as f:
